...
class Bankaccount_index_Query:
    ...
    status: Optional[Literal['opened', 'closed']] = None
...
class Banktransaction_index_Query:
    ...
    unreconciled_only: Optional[bool] = None
    updated_since: Optional[datetime.datetime] = None

@dataclass
class Banktransaction_create_Query:
    X_API_VERSION: Optional[str] = None
    fields: Optional[str] = None
...
@dataclass
class Banktransaction_update_Query:
    id: int
    IF_MATCH: Optional[str] = None
    X_API_VERSION: Optional[str] = None
    fields: Optional[str] = None
...
@dataclass
class Banktransaction_destroy_Query:
    id: int
    X_API_VERSION: Optional[str] = None
...
@dataclass
class Cliofile_submission_index_Query:
    X_API_VERSION: Optional[str] = None
    created_since: Optional[datetime.datetime] = None
    fields: Optional[str] = None
    ids__: Optional[int] = None
    limit: Optional[int] = None
    order: Optional[Literal['id(asc)', 'id(desc)', 'submitted_date(asc)', 'submitted_date(desc)']] = None
    page_token: Optional[str] = None
...
class Relatedcontacts_index_Query:
    ...
    fields: Optional[str] = None
    limit: Optional[int] = None
    order: Optional[Literal['id(asc)', 'id(desc)', 'contact.name(asc)', 'contact.name(desc)']] = None
    page_token: Optional[str] = None
...
class User_index_Query:
    ...
    limit: Optional[int] = None
    name: Optional[str] = None
    order: Optional[Literal['enabled(asc)', 'enabled(desc)', 'id(asc)', 'id(desc)', 'name(asc)', 'name(desc)', 'first_name(asc)', 'first_name(desc)', 'last_name(asc)', 'last_name(desc)', 'initials(asc)', 'initials(desc)', 'subscription_type(asc)', 'subscription_type(desc)']] = None
    page_token: Optional[str] = None
...
@dataclass
class Documentversion_save_as_latest_version_Query:
...
class Folder_index_Query:
    ...
    limit: Optional[int] = None
    matter_id: Optional[int] = None
    order: Optional[Literal['id(asc)', 'id(desc)', 'name(asc)', 'name(desc)', 'updated_at(asc)', 'updated_at(desc)']] = None
    page_token: Optional[str] = None
    parent_id: Optional[int] = None
    query: Optional[str] = None
    scope: Optional[Literal['descendants', 'children']] = None
