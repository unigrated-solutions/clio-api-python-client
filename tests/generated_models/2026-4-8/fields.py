...
@dataclass
class ClioFileSubmissionsReport_Fields:
    # Fields directly copied from ClioFileSubmissionsReport_base
    id: Optional[int] = None
    etag: Optional[str] = None
...
class Contact_Fields:
    ...
    kyc_field_values: Optional[KycFieldValue_base] = KycFieldValue_base
