...
@dataclass
class ClioFileSubmissionsReport_base:
    id: Optional[int] = None
    etag: Optional[str] = None
...
class LaukCivilControlledRate_base:
    ...
    post_dec25_exceptional: Optional[float] = None
    post_dec25_fee: Optional[float] = None
    rate_type: Optional[str] = None
    region: Optional[str] = None
    updated_at: Optional[datetime.datetime] = None
...
class LogEntry_base:
    id: Optional[int] = None
    etag: Optional[str] = None
    type: Optional[Literal['MatterLogEntry', 'ContactLogEntry', 'DocumentLogEntry', 'CalendarEntryLogEntry', 'NoteLogEntry', 'CommunicationLogEntry', 'ConversationLogEntry', 'SMSConversationLogEntry']] = None
...
class BillingSetting_base:
    ...
    apply_secondary_tax_by_default: Optional[bool] = None
...
class KycFieldValue_base:
    ...
    created_at: Optional[datetime.datetime] = None
    updated_at: Optional[datetime.datetime] = None
    field_type: Optional[Literal['date', 'picklist', 'text']] = None
    field_value: Optional[str] = None
    field_possible_values: Optional[List[str]] = None
...
class PolymorphicObject_base:
    id: Optional[int] = None
    type: Optional[Literal['Task', 'CalendarEntry', 'MatterNote', 'ContactNote', 'Matter', 'Contact', 'User', 'CreditMemo', 'Payment', 'Document', 'Communication', 'Conversation', 'TextMessageConversation']] = None
    identifier: Optional[str] = None
    secondary_identifier: Optional[str] = None
